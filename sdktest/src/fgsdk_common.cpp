/**
 * Copyright (C) 2001-2014, Foxit Software Inc..
 * All Rights Reserved.
 *
...
#include "../include/fgsdk_common.h"
...
bool FSDK_InitializeLibray(bool useDefMgr)
{
	...
	if (ret == FSCRT_ERRCODE_SUCCESS)
	{
		...
		license_id.str = (FS_LPSTR)"R9u+EUjgGoICEQpD3yr0gylVIV0esxnL6UTSZfBGyEy9a8TGTZEaNw==";
		license_id.len = strlen(license_id.str);
		FSCRT_BSTR unlockCode;
		unlockCode.str = (FS_LPSTR)"";
